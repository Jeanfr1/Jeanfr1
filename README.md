...
<div align="center">
  <img src="https://skillicons.dev/icons?i=react,nextjs,typescript,tailwind,nodejs,express,mongodb,postgres,aws,solidity,ethereum&theme=dark&perline=11" />
</div>
...
<div align="center" style="margin-top:10px;">
  ...
  <img src="https://img.shields.io/badge/n8n-24933C?style=for-the-badge&logo=n8n&logoColor=white" alt="n8n" />
</div>
...
<div align="center">
  <table>
    <tr>
      ...
      <td>
        <p align="left">
          I'm a <b>Fullstack Developer</b> with a deep passion for <b>frontend excellence</b>, immersed in the ever-evolving worlds of <b>Web3</b> and <b>Automation</b>. My core focus is on crafting exceptional user interfaces and fluid digital experiences using modern frontend technologies.
          <br /><br />
          While automation and decentralized systems complement my work, my heart beats for innovative, pixel-perfect frontend solutions that push boundaries and redefine user engagement.
          <br /><br />
          Whether I'm developing next-gen dApps or architecting scalable web applications, I bring creative energy and technical precision to every project. I believe in bridging the gap between design and function to create futuristic, immersive experiences.
        </p>
      </td>
    </tr>
  </table>
...
<div align="center">
  <img src="https://img.shields.io/badge/CURRENT_FOCUS-FRONTEND_|_WEB3_|_AUTOMATION-blueviolet?style=for-the-badge&logo=targetprocess&logoColor=white" alt="Current Focus Badge" />
</div>
  ...
  <table>
    <tr>
      <td align="center">
        ...
        <p>Engineering dynamic and responsive interfaces with React, Next.js, and Tailwind CSS.</p>
      </td>
      <td align="center">
        ...
        <br />
        <b>Web3 Ventures</b>
        <p>Building decentralized applications (dApps) using Ethers.js, Hardhat, and smart contracts.</p>
      </td>
    </tr>
    <tr>
      <td align="center">
        ...
        <br />
        <b>Automation & Workflow Integration</b>
        <p>Focusing on leveraging tools like Make and n8n to streamline processes and enhance automation within applications.</p>
      </td>
      <td align="center">
        ...
        <p>Experimenting with cutting-edge tools and methodologies to stay ahead in the fullstack landscape.</p>
      </td>
    </tr>
  </table>
</div>
  ...
  <table>
    <tr>
      <td>
        ...
        <p><i>Dec 2024 – Present | Remote, France</i></p>
        <p><b>Role:</b> Frontend Developer | React | TypeScript | Web3 Enthusiast | UX/UI</p>
        <ul>
          <li>Architected scalable frontend systems with React, Next.js, and Node.js.</li>
          <li>Integrated decentralized solutions with Ethers.js, Hardhat, and smart contracts.</li>
          <li>Translated advanced UI/UX designs into responsive and interactive interfaces.</li>
          <li>Led groundbreaking 0-to-1 initiatives, shaping innovative dApp and DEX designs.</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td>
        ...
        <p><b>Role:</b> AI Developer & Integration Specialist</p>
        <ul>
          <li>Streamlined workflows with AI-powered automation, reducing manual effort by 40%.</li>
          <li>Developed data pipelines and integrated machine learning models for predictive insights.</li>
          <li>Enhanced project delivery with smart automation and efficient data integration processes.</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td>
        <h3>🌐 HP (HPE Flex Offers Program)</h3>
        <p><b>Role:</b> Strategic Outreach & Training Lead</p>
        <ul>
          <li>Led training programs boosting adoption by 20%.</li>
          <li>Developed custom solutions to enhance customer engagement and satisfaction.</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td>
        <h3>💻 Microsoft</h3>
        <p><b>Role:</b> Technology Project Support</p>
        <ul>
          <li>Optimized business processes, cutting operational costs by 18%.</li>
          <li>Implemented innovative automation strategies to drive client productivity.</li>
        </ul>
      </td>
    </tr>
  </table>
  ...
  <table>
    <tr>
      ...
      <td align="center">
        ...
        <p>Ethereum, Smart Contract Development, Hardhat, Ethers.js, Decentralized Application (dApp) Design</p>
      </td>
    </tr>
    <tr>
      <td align="center">
        ...
        <h3>Backend & Cloud</h3>
        <p>Node.js, Express.js, MongoDB, PostgreSQL, AWS, GraphQL, Redis</p>
      </td>
      <td align="center">
        ...
        <p>Make, n8n, Automation, Python, Data Analysis, API Integration</p>
      </td>
    </tr>
    <tr>
      <td align="center">
        ...
        <p>Cross-Functional Leadership, Agile Methodologies, Project Management, Git, CI/CD</p>
      </td>
      <td align="center">
        ...
        <h3>Communication</h3>
        <p>Multilingual in English, French, and Portuguese, Technical Documentation, Client Presentations</p>
      </td>
    </tr>
  </table>
</div>
